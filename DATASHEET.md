...
*To be finalised before public release.* The intended split is a permissive licence for code and
an open data licence for the generated datasets and calibration tables. Until the licence file
lands, this repository is a private preview for collaborators, all rights reserved.
