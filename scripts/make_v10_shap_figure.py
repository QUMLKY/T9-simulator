"""V10 SHAP figure for the KDD paper / dissertation.
...
Run from repo root:
  t9_sim/venv/Scripts/python.exe t9_sim/scripts/make_v10_shap_figure.py
...
fig.suptitle("T9 v10 SHAP attributions - 10M auctions, seed 90217, "
             ...
             fontsize=9, y=1.02)
fig.tight_layout()
out = ROOT / "diagrams" / "T9_SHAP_figure_v10"
